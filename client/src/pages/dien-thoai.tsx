...
const Smartphone = () => {
	const sliderImgs: IImage[] = [
		{
			id: 1,
			link: 'https://cdn.tgdd.vn/2021/12/banner/800-200-800x200-205.png',
			name: 'Smartphone Gắn Kết - Lì Xì Đến 5 Triệu',
		},
		{
			id: 2,
			link: 'https://cdn.tgdd.vn/2021/12/banner/tet-samsung-800-200-800x200.png',
			name: 'Đồng Hồ Xả Hàng - Giảm Đến 50%++',
		},
		{
			id: 3,
			link: 'https://cdn.tgdd.vn/2022/01/banner/800-200-800x200.png',
	...
	const bannerImgs: IImage[] = [
		{
			id: 1,
			link: 'https://cdn.tgdd.vn/2021/12/banner/Sticky-390x97.png',
			name: 'ạdskadjasjd',
		},
		{
			id: 2,
			link: 'https://cdn.tgdd.vn/2022/01/banner/sticky-A55-390x97-1.png',
			name: 'áhdhjasd',
		},
	]
